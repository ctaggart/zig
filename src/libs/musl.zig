...
const src_files = [_][]const u8{
    ...
    //"musl/src/math/j0.c", // migrated to lib/c/math.zig; exports: j0,y0
    //"musl/src/math/j0f.c", // migrated to lib/c/math.zig; exports: j0f,y0f
    //"musl/src/math/j1.c", // migrated to lib/c/math.zig; exports: j1,y1
    //"musl/src/math/j1f.c", // migrated to lib/c/math.zig; exports: j1f,y1f
    //"musl/src/math/lgammal.c", // migrated to lib/c/math.zig; exports: lgammal,lgammal_r
    ...
    //"musl/src/math/llround.c", // migrated to lib/c/math.zig
    //"musl/src/math/log1p.c", // migrated to lib/c/math.zig
    //"musl/src/math/log1pl.c", // migrated to lib/c/math.zig
    //"musl/src/math/lround.c", // migrated to lib/c/math.zig
    ...
    //"musl/src/network/recvmmsg.c", // migrated to lib/c/network.zig; exports: recvmmsg,__recvmmsg_time64
    ...
    //"musl/src/time/strftime.c", // migrated to lib/c/time.zig
    //"musl/src/time/strptime.c", // migrated to lib/c/time.zig
    //"musl/src/time/time.c", // migrated to lib/c/time.zig
    //"musl/src/time/timer_create.c", // migrated to lib/c/time.zig
    ...
    //"musl/src/stdio/putc.c", // migrated to lib/c/stdio.zig
    //"musl/src/stdio/putc_unlocked.c", // migrated to lib/c/stdio.zig
