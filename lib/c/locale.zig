...
const c_lconv = extern struct {
    ...
    int_frac_digits: c_char = -1, // CHAR_MAX in C with implicit wrap
    frac_digits: c_char = -1, // CHAR_MAX in C with implicit wrap
    p_cs_precedes: c_char = -1, // CHAR_MAX in C with implicit wrap
    p_sep_by_space: c_char = -1, // CHAR_MAX in C with implicit wrap
    n_cs_precedes: c_char = -1, // CHAR_MAX in C with implicit wrap
    n_sep_by_space: c_char = -1, // CHAR_MAX in C with implicit wrap
    p_sign_posn: c_char = -1, // CHAR_MAX in C with implicit wrap
    n_sign_posn: c_char = -1, // CHAR_MAX in C with implicit wrap
    int_p_cs_precedes: c_char = -1, // CHAR_MAX in C with implicit wrap
    int_p_sep_by_space: c_char = -1, // CHAR_MAX in C with implicit wrap
    int_n_cs_precedes: c_char = -1, // CHAR_MAX in C with implicit wrap
    int_n_sep_by_space: c_char = -1, // CHAR_MAX in C with implicit wrap
    int_p_sign_posn: c_char = -1, // CHAR_MAX in C with implicit wrap
    int_n_sign_posn: c_char = -1, // CHAR_MAX in C with implicit wrap
};
