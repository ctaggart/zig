...
fn ucontext_sigmask(ctx: *anyopaque) *linux.sigset_t {
    ...
    const off = switch (arch) {
        .arm, .armeb, .i386, .m68k, .powerpc, .powerpcle, .powerpc64, .powerpc64le, .s390x, .x86, .x86_64 => 3 * ptr_size + @sizeOf(linux.stack_t) + mcontext_size,
...
fn ucontext_pc(ctx: *anyopaque) *usize {
    ...
    const uc_mcontext = switch (arch) {
        .arm, .armeb, .i386, .m68k, .powerpc, .powerpcle, .powerpc64, .powerpc64le, .s390x, .x86, .x86_64 => 3 * ptr_size + @sizeOf(linux.stack_t),
